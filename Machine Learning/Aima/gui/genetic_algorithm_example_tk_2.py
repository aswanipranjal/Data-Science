...
max_population_slider = Scale(f1, from_=3, to=1000, orient=HORIZONTAL, label='Max Population', command=lambda value, name=scale: update_max_population(name, value))
