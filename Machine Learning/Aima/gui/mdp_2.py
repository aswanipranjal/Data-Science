...
entry_h.pack(pady=10, padx=10, side=LEFT, fill=X)
label_x = ttk.Label(frame2, text='X', font=('Verdana', 10))
label_x.pack(pady=10, padx=4, side=LEFT, fill=X)
entry_w = Entry(frame2, font=('Verdana', 10), width=3, justify=CENTER)
entry_w.pack(pady=10, padx=10, side=LEFT, fill=X)
button = ttk.Button(frame2, text='Build a GridMDP')
button.pack(pady=10, padx=10, side=TOP, fill=X)
