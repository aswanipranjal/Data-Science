...
def test_policy_iteration():
    ...
    print(policy_iteration(sequential_decision_environment_3))
    assert (policy_iteration(sequential_decision_environment_3) == {
        ...
        (5, 0): None, (5, 1): (0, 1), (5, 2): (0, 1), (5, 3): (0, 1), (5, 4): (1, 0)} or policy_iteration(sequential_decision_environment_3) == {
        (0, 0): (0, -1), (0, 1): (0, -1), (0, 2): (0, -1), (0, 3): (0, -1), (0, 4): None,
        (1, 0): (-1, 0), (1, 1): (-1, 0), (1, 4): (1, 0),
        (2, 0): (-1, 0), (2, 1): (0, -1), (2, 2): None, (2, 4): (1, 0),
        (3, 0): (-1, 0), (3, 2): None, (3, 3): (1, 0), (3, 4): (1, 0),
        (4, 0): (-1, 0), (4, 3): (1, 0), (4, 4): (1, 0),
